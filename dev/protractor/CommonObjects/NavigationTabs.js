_NavigationTabs = function() {
    ...
    this.PreSaleTab=this.NavBar.element(by.css('li:nth-child(14) a'));
    ...
    this.AutoBuyTab=this.NavBar.element(by.css('li:nth-child(17) a'));
    this.AutoBuyTab.url='autobuy';
    this.AutoBuyTab.label='Auto Buy';

    this.FeaturedListAddBooksTab=this.NavBar.element(by.css('li:nth-child(20) a'));
    this.FeaturedListAddBooksTab.url='featured-list-management';
    this.FeaturedListAddBooksTab.label='Featured List Add Books';

    this.FeaturedListLandingPageListOrderTab=this.NavBar.element(by.css('li:nth-child(21) a'));
